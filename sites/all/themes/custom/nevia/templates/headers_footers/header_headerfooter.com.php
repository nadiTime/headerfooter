  ...
  <div class="container inov-nav">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" id="navbar-brand" href="/">
        <img src="/sites/all/themes/custom/test_innovators/images/logo-isee.png">
      </a>
    </div>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="/content/store" class="dropdown-toggle disabled" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pricing<span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="/content/lower-level-isee">Lower Level</a></li>
              <li><a href="/content/middle-level-isee">Middle Level</a></li>
              <li><a href="/content/upper-level-isee">Upper Level</a></li>
            </ul>
          </li>
